...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.secret) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secret');
    }
  ...
  _secret_0(context, partialProofData) {
    ...
    const [nextPrivateState_0, result_0] = this.witnesses.secret(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('secret',
                                 'return value',
                                 'canary.compact line 13 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _commitmentOf_0(s_0) { return this._persistentHash_0(s_0); }
  _claim_0(context, partialProofData) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'Already claimed');
    const h_0 = this._persistentHash_0(this._secret_0(context, partialProofData));
    __compactRuntime.assert(this._equal_0(h_0,
...
const _dummyContract = new Contract({ secret: (...args) => undefined });
  ...
  commitmentOf: (...args_0) => {
    ...
    if (!(s_0.buffer instanceof ArrayBuffer && s_0.BYTES_PER_ELEMENT === 1 && s_0.length === 32)) {
      __compactRuntime.typeError('commitmentOf',
                                 'argument 1',
                                 'canary.compact line 22 char 1',
                                 'Bytes<32>',
                                 s_0)
    }
    return _dummyContract._commitmentOf_0(s_0);
  }
};
